<?php
    ...
    $data = json_decode(file_get_contents("http://localhost:8080/ProyRestaurant/operation/delete/CLIENT/$name"), true);
?>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4">
                    <a class="nav-link text-uppercase text-expanded" href="about.html">CLIENT</a>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-5">
                ...
                <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>Client:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['nameClient']}</p>"); ?>
                    </span>
                    </li>
