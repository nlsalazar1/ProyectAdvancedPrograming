        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4">
                    <a class="nav-link text-uppercase text-expanded" href="about.html">SAUCER</a>
                    </li>
                </ul>
                </div>
            </div>
            ...
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-5">
                ...
                <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <?php echo("<b>COST:</b>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['costPurchase']}</p>"); ?>
                    </span>
                    </li>
                    ...
                    <?php echo("<p> <b>ID:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['idPurchase']}</p>"); ?>
                    </span>
                    </li>
                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>SAUCER:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['namePurchase']}</p>"); ?>
                    </span>
                    </li>
                    ...
                    <span class="ml-auto">
                        <?php echo("<p>{$data['qualificationPurchase']}</p>"); ?>
                    </span>
                    </li>

                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>TIKET:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['tiket']}</p>"); ?>
                    </span>
                    </li>
                </li>
              </ul>
