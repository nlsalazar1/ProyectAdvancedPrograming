<?php
    ...
    $mail = $_GET['mail'];
    $data = json_decode(file_get_contents("http://localhost:8080/CyberRestaurant/operation/register/CLIENT/$id/$name/$lastname/$telephone/$mail"), true);
?>
            ...
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-5">
                ...
                <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <span class="ml-auto">
                        <?php echo("<p>{$data['firsname']}</p>"); ?>
                    </span>
                    </li>

                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>LASTNAME:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['lastname']}</p>"); ?>
                    </span>
                    </li>

                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>TELEPHONE:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['telephone']}</p>"); ?>
                    </span>
                    </li>

                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>MAIL:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['mail']}</p>"); ?>
                    </span>
                    </li>
                </ul>
            </div>
