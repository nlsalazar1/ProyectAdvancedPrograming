...
<html>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark py-lg-4" id="mainNav">
            <div class="container">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4">
                    <a class="nav-link text-uppercase text-expanded" href="client.html">LOGIN</a>
                    </li>
                </ul>
                </div>
            </div>
    ...
    <footer class="footer text-faded text-center py-5"> 
        <div class="container">
            ...
            <button align="center" onclick="location.href='./login.html'" style="background:rgba(27, 15, 1, 0.9)" 
            class="btn btn-primary" name="cl" id="cl">
            MENU LOGIN
            </button>
