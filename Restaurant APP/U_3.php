<?php
    ...
    $name = $_GET['name'];
    $cost = $_GET['cost'];
    $data = json_decode(file_get_contents("http://localhost:8080/CyberRestaurant/operation/register/SAUCER/$id/$name/$cost"), true);
?>
            ...
            <div class="cta-inner text-center rounded">
              <h2 class="section-heading mb-5">
                ...
                <ul class="list-unstyled list-hours mb-5 text-left mx-auto">
                    ...
                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>COST:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['cost']}</p>"); ?>
                    </span>
                    </li>

                    <li class="list-unstyled-item list-hours-item d-flex">
                    <?php echo("<p> <b>QUALIFICATION:</b></p>");?>
                    <span class="ml-auto">
                        <?php echo("<p>{$data['qualification']}</p>"); ?>
                    </span>
                    </li>
                </ul>
            </div>
